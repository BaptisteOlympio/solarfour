...
class UnitVectorTest {
        ...
        void shouldPointInCardinalDirection(double azimuth, double altitude, double expectedX,
                ...
                assertEquals(expectedX, v.getX(), DELTA, "X component mismatch for azimuth="
                                + azimuth + ", altitude=" + altitude);
                assertEquals(expectedY, v.getY(), DELTA, "Y component mismatch for azimuth="
                                + azimuth + ", altitude=" + altitude);
                assertEquals(expectedZ, v.getZ(), DELTA, "Z component mismatch for azimuth="
                                + azimuth + ", altitude=" + altitude);
        }
